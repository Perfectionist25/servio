...
3. Запустите:
   ...
   ```
   Для запуска Django или бота напрямую с хоста используются локальные fallback-адреса:
   `POSTGRES_HOST_LOCAL=127.0.0.1`, `POSTGRES_PORT_LOCAL=5433`, `REDIS_HOST_LOCAL=127.0.0.1`.
